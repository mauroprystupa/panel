                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form action="cuentas_a_pagar.php" method="post">
                                                <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    <label for="example-tel-input" class="col-sm-2 form-label align-self-center mb-lg-0 text-end">Importe</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <label for="example-password-input" class="col-sm-2 form-label align-self-center mb-lg-0 text-end">Pagado</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text">
                                                    </div>
                                                </div>
                                                <button type="submit" class="btn btn-primary">Guardar</button>
                                                <a href="cuentas_a_pagar.php" type="button" class="btn btn-danger">Cancelar</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
